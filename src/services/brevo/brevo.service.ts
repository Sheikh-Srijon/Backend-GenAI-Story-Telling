                          ...
                          <table width="600" cellspacing="0" cellpadding="0">
                              <tr>
                                  <td style="background-color: #8000b3; padding: 10px; text-align: center; color: #fff;">
                                      <h1>Welcome to the GenAI Story Telling!</h1>
                                  </td>
                              </tr>
                              <tr>
                                  <td style="padding: 20px;">
                                      ...
                                      <p>Please keep your login information secure.
                                  </td>
                              </tr>
                              <tr>
                  ...
                  <tr>
                      <td align="center">
                          <table width="600" cellspacing="0" cellpadding="0">
                              <tr>
                                  <td style="background-color: #8000b3; padding: 10px; text-align: center; color: #fff;">
                                      <h1>GenAI Story Telling - Password Reset</h1>
                                  </td>
                              </tr>
                              <tr>
                                  <td style="padding: 20px;">                                   
                                      ...
                                      <p>If you did not ask for a password reset request, you can ignore this email. Otherwise you can use the above link to reset your password.</p>
                                  </td>
                              </tr>
                              <tr>
                                  <td style="background-color: #f5f5f5; padding: 10px;">
